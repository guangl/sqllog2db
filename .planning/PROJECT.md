...
- ✓ **FILTER-03**: 排除过滤器（exclude filters）——7 个 exclude_* 字段，OR-veto 语义，FilterProcessor 路由修复，配置模板更新 — Phase 8
- ✓ **PERF-10**: samply + criterion 量化热路径，D-G1 门控未触发（最高 src/ 函数 4.6% < 5%），记录"已达当前瓶颈"结论，729 测试全通过 — Phase 10
...
---
*Last updated: 2026-05-15 — Phase 10 complete (PERF-10 热路径门控，已达当前瓶颈)*
